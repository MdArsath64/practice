//Create Employee class with years of service calculation
// Employee.java
...
//Main.java
class ServiceCalculationOfEmployee {
  public static void main(String[] args) {
  //  System.out.println("")
    Employee employee1 = new Employee("Roberta Petrus", 50000, LocalDate.parse("2020-04-01"));
